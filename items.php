...
<head>
    ...
    <title>Inventory Manager - Items</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="items.php">Items</a>
               ...
               <!-- Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="modal fade" id="addItemModal" tabindex="-1" role="dialog" aria-labelledby="addItemModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="server/api/add_item.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="cost_price" name="cost_price" required min="0">
                                        </div>
                                        <div class="form-group">
                                            <label for="low_stock_threshold">Low Stock Threshold</label>
                                            <input type="number" class="form-control" id="low_stock_threshold" name="low_stock_threshold" required min="0">
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php include __DIR__ . '/tables.php'; ?>
                        </div>
                    </div>
